TASK: Compose a counterpoint voice ABOVE the given cantus firmus in second species counterpoint (two half notes against each whole note). The counterpoint must be on STAFF 1 (top staff) and the cantus firmus on STAFF 2 (bottom staff).
...
- Do NOT add any rests or silences — every measure must be completely filled with notes
