TASK: Compose a counterpoint voice ABOVE the given cantus firmus in third species counterpoint (four quarter notes against each whole note). The counterpoint must be on STAFF 1 (top staff) and the cantus firmus on STAFF 2 (bottom staff).
...
STRUCTURE:
- Measures 1 to (N-1): exactly FOUR quarter notes per measure
