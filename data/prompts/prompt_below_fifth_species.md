TASK: Compose a counterpoint voice BELOW the given cantus firmus in fifth species counterpoint (florid counterpoint — a free combination of whole notes, half notes, quarter notes, and syncopations). The cantus firmus must be on STAFF 1 (top staff) and the counterpoint on STAFF 2 (bottom staff).
