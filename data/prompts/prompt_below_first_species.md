TASK: Compose a counterpoint voice BELOW the given cantus firmus in first species counterpoint (note against note). The cantus firmus must be on STAFF 1 (top staff) and the counterpoint on STAFF 2 (bottom staff).
