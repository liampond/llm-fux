...
| S5-2 | Suspension usage | At least 2 tied syncopations must be present and correctly used as prescribed by the 4th species suspension tables. Of these, at least one must be a dissonant syncopation and at least one must be a consonant syncopation. | Pass / Fail |
